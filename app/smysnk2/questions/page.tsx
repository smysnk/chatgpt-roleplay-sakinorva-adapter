...
function Smysnk2QuestionsContent() {
  ...
  const displayedOptions = useMemo(() => {
    ...
    const order = getSmysnk2OptionDisplayOrder(currentQuestion.id, currentQuestion.options.length);
            ...
            <div className="answer-row">
              <div className="answer-meta" style={{ alignItems: "flex-start", justifyContent: "flex-start" }}>
                <div>
                  ...
                  <p className="helper" style={{ marginTop: "8px" }}>
                    You will answer {totalCount} scenario questions in {SMYSNK2_MODE_LABELS[mode].toLowerCase()}.
                    Pick the option that best matches your first instinct in that moment.
                  </p>
                  <p className="helper" style={{ marginTop: "8px" }}>
                    {answeredCount > 0
              ...
              <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
                ...
                <button type="button" className="button secondary" onClick={() => router.push("/smysnk2")}>
                  Back to SMYSNK2
                </button>
              </div>
            </div>
